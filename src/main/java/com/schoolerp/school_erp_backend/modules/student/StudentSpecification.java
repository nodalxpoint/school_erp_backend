...
public class StudentSpecification {
    ...
    public static Specification<StudentEntity> firstNameLike(
            String firstName
    ) {

        return (root, query, cb) ->
                FilterUtils.likeIgnoreCase(
                        cb,
                        root,
                        "firstName",
                        firstName
    ...
    public static Specification<StudentEntity> lastNameLike(
            String lastName
    ) {
    ...
    public static Specification<StudentEntity> admissionNoEqual(
            String admissionNo
    ) {
    ...
    public static Specification<StudentEntity> classIdEqual(
            Long classId
    ) {

        return (root, query, cb) ->
                FilterUtils.joinEqual(
                        cb,
                        root,
                        "schoolClass",
                        "id",
